$(function () {
  ...
  $('.blog__sliger-inner').slick({
    ...
    slidesToShow: 3,
    slidesToScroll: 3,
    prevArrow: '<button type="button" class="slick-prev"><img src="images/icons/slider_prev.png" alt=""></button>',
    nextArrow: '<button type="button" class="slick-next"><img src="images/icons/slider_next.png" alt=""></button>',
  });
